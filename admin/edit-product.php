                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-content">
                        ...
                        <div class="form-group pb-0 p-2 row">
                            ...
                            <div class="col-md-10">
                                <input id="input_Title" value="<?php echo $result_product['productName']?>" name="productName" class="form-control" type="text"
                                    />
                            </div>
                        </div>
                        <div class="form-group row pb-0 p-2">
                            ...
                            <div class="col-md-2">
                                <input id="input_Price" name="price" class="form-control" type="text" value="<?php echo $result_product['price']?>"
                                     />
                            </div>

                            <label class="col-md-2 col-form-label text-center">Số Lượng:</label>
                            <div class="col-md-2">
                                <input id="input_Price" name="soluong" class="form-control text-right" type="text" value="<?php echo $result_product['soluong']?>" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row p-2">
                            ...
                            <div class="col-md-10">
                                <a id="a_Avatar" href="../admin/images/noimage.png" target="_blank"
                                    ...
                                    <img id="img_Avatar"src="uploads/<?php echo $result_product['image']?>"             
                        ...
                        <div class="form-group row pb-0 p-2">
                            ...
                            <div class="col-md-10">
                                <textarea name="description"id="textarea_Content" rows="10"
                                    class="form-control tinyeditor"><?php echo $result_product['description']?></textarea>
                            </div>
                        </div>
                        <div class="form-group row pb-0 p-2">
                            ...
                            <div class="col-md-10">
                                <select name="type" class="form-control">
                                    ...
                                    <?php
                                        ...
                                        <option selected value="2" value="2">Sản phẩm không nổi bật</option>
                                    <?php
                                    }
                                    ?>
                                </select>
